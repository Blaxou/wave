...
class _WaveWidgetState extends State<WaveWidget> with TickerProviderStateMixin {
  ...
  void _initAnimations() {
    ...
    _wavePhaseValues = _waveControllers.map((controller) {
      ...
      final Animation<double> value = Tween(
  ...
  List<Widget> _buildPaints() {
    ...
    final List<Color> _colors = widget.config.colors;
    final List<List<Color>> _gradients = widget.config.gradients;
    final Alignment begin = widget.config.gradientBegin;
    final Alignment end = widget.config.gradientEnd;
